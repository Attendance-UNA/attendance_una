        ...
        <section class="page-section portfolio" id="newActivity">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Iniciar una nueva reuni&oacuten</h2>
                </div>
                <!-- Icon Divider-->
                            ...
                            <form>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="activityName" aria-describedby="nameHelp" placeholder="Ingrese el nombre de la actividad">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="activityDescription" placeholder="Ingrese una descripción acerca de la actividad">
                                    </div>
                                    <div class="form-group">
                                        <label for="activityManagername">Nombre del encargado:</label>
                                        <input type="text" class="form-control" id="activityManagername" placeholder="Ingrese el nombre completo">
                                    </div>
                                ...
                                <div class="row justify-content-end">
                                    <button type="submit" data-dismiss="modal" class="btn btn-primary"><i class="fas fa-check-circle"></i> Iniciar</button>
